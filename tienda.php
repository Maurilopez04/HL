...
<path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            <div class="offcanvas-header bg-black">
              <h5 class="offcanvas-title" id="offcanvasNavbarLabel"><img width=190px src="img/logo.png" alt="" srcset=""></h5>
    ...
    <li class="nav-item dropdown">
      ...
      <li></li>
            ...
            <a class="btn btn-success mb-2 mt-1" href=""><i class="fa-solid fa-phone"></i> 0983047400</a>
...
<div class="row mt-5 me-1 ms-1 pc-none">
  <div class="col-md-4 m-0 w-30">
    <img src="img/Categorias.png" alt="" class="w-100 h-100">
  </div>
    <div class="col-md-8 m-0 w-70">
    <div class="contenedorr">

    <div class="categoria align-items-center">
      <img src="img/Portfolio/8.jpeg" alt="" width="35%">
      <div style="width: 65%;">
      <h5 class="" style="text-align: center;">LED</h5>
      </div>
    </div>

        <div class="categoria align-items-center">
      <img src="img/Portfolio/1.jpg" alt="" width="35%">
      <div style="width: 65%;">
      <h5 class="" style="text-align: center;">Valijas</h5>
      </div>
    </div>

        <div class="categoria align-items-center">
      <img src="img/Portfolio/3.jpg" alt="" width="35%">
      <div style="width: 65%;">
      <h5 class="" style="text-align: center;">Alarmas</h5>
      </div>
    </div>

            <div class="categoria align-items-center">
      <img src="img/2.jpeg" alt="" width="35%">
      <div style="width: 65%;">
      <h5 class="" style="text-align: center;">Audio</h5>
      </div>
    </div>
      ...
      <img src="img/2.jpeg" alt="" width="35%">
      <div style="width: 65%;">
      <h5 class="" style="text-align: center;">Carpas</h5>
      </div>
    </div>
      ...
      <img src="img/2.jpeg" alt="" width="35%">
      <div style="width: 65%;">
      <h5 class="" style="text-align: center;">Alfombras</h5>
      </div>
    </div>
      ...
      <img src="img/2.jpeg" alt="" width="35%">
      <div style="width: 65%;">
      <h5 class="" style="text-align: center;">TiraTrailer</h5>
      </div>
    </div>
